...
exports.sendPushNotification = function sendPushNotification(req,res,next){
  var body = req.body;
  ...
  fireadmin.messaging().sendToDevice(registrationToken, message, options).then( response => {
